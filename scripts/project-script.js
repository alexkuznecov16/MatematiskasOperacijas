...
function izveidotDok() {
    ...
    var mansDok = '<title>Diagramma</title><body style="margin:0; padding:10px; background-color:#e3ece3; text-align:center;"><img src="./images/flowchart_Mon_Nov_06_2023_17_45_33_GMT+0200_(Eastern_European_Standard_Time).svg" style="width: 95%;" alt="No JavaScript code in this example"><br></body>';
